...
namespace ResourceDesigner.Classes
{
    public unsafe static class BinOps
    {
        ...
        /// </summary>
        /// <param name="bytes">The byte array to rotate.</param>
        public static void RotateRight(this byte[] bytes)
        {
        ...
        public static bool ShiftLeft(this byte[] bytes)
        {
        ...
        /// </summary>
        /// <param name="bytes">The byte array to shift.</param>
        public static bool ShiftRight(this byte[] bytes)
        {
